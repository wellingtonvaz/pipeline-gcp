resource "google_container_node_pool" "endpoints-cluster_endpoints-pool-1-dr" {
  cluster            = google_container_cluster.endpoints-cluster-dr.name
