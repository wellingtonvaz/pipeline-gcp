resource "google_container_cluster" "endpoints-cluster-prod" {
  ...
  network = "projects/unik-gke-prd/global/networks/unik-amosh-gke-nodes-subnet"
  network_policy {
    enabled = "false"
  }
  ...
  subnetwork      = "projects/unik-gke-prd/regions/us-east1/subnetworks/cash-in-subnet-prod"
}