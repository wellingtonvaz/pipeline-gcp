resource "google_container_cluster" "endpoints-cluster-prod" {
  ...
  network = "projects/br-chek-prod/global/networks/unik-amosh-shared-vpc"
  network_policy {
    enabled = "false"
  }
  ...
  subnetwork      = "projects/br-chek-prod/regions/us-east4/subnetworks/unik-amosh-gke-nodes-subnet"
}